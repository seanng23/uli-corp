...
export const FITTINGS: Fitting[] = [
  ...
  { code:"UL1066",family:"Flat Plate Fittings",description:"3-hole straight splice plate",specs:["137mm length"],image:IMG+"ul1066-v2.png" },
  ...
  { code:"UL1036",family:"Flat Plate Fittings",description:"3-hole 90-degree corner (L-shape) flat plate",specs:["89 x 89mm leg lengths"],image:IMG+"ul1036-v2.png" },
  ...
  { code:"UL1028",family:"Flat Plate Fittings",description:"5-hole cross (+) shape flat plate (4 arm holes + centre hole)",specs:["137 x 137mm"],image:IMG+"ul1028-v2.png" },
  ...
  { code:"UL1068",family:"Angular Fittings",description:"2-hole 90-degree angle bracket (1 hole per leg)",specs:["41 x 58mm"],image:IMG+"ul1068-v2.png" },
  ...
  { code:"UL1130",family:"Angular Fittings",description:"Gusseted shelf/support bracket, triangular web, slotted holes in base (2 slots) and 2 holes in upright face",specs:["93mm upright height","47mm base width","38 and 38mm slot spacings","A 168mm","B 102mm"],image:IMG+"ul1130-v2.png" },
  { code:"UL1131",family:"Angular Fittings",description:"Gusseted shelf/support bracket, triangular web, slotted holes in base (2 slots) and 2 holes in upright face",specs:["93mm upright height","47mm base width","38 and 38mm slot spacings","A 219mm","B 152mm"],image:IMG+"ul1130-v2.png" },
  ...
  { code:"UL2072",family:"Post Base Plates",description:"U-cradle (3-sided) upstand welded to square base plate, for single channel (UL1000 series); 2 side holes",specs:["41mm upstand","6.0mm plate","plan 152/76/76","4 holes 14 dia"],image:IMG+"ul2072-v2.png" },
  { code:"UL2072A",family:"Post Base Plates",description:"Same U-cradle, tall upstand; 4 side holes (2 per face)",specs:["89mm upstand","6.0mm plate","plan 152/76/76","4 holes 14 dia"],image:IMG+"ul2072a-v2.png" },
  { code:"UL2073",family:"Post Base Plates",description:"U-cradle for UL1001 Series (back-to-back channel), wide throat; labelled UL1001 Series",specs:["41mm upstand","6.0mm plate","plan 152/76/76","4 holes 14 dia"],image:IMG+"ul2073-v2.png" },
  { code:"UL2073A",family:"Post Base Plates",description:"Tall U-cradle for UL1001 Series",specs:["89mm upstand","6.0mm plate","plan 152/76/76","4 holes 14 dia"],image:IMG+"ul2073a-v2.png" },
  { code:"UL2074",family:"Post Base Plates",description:"L/angle-style (2-sided) upstand welded to square base plate, single channel",specs:["41mm upstand","6.0mm plate","plan 152/76/76","4 holes 14 dia"],image:IMG+"ul2074-v2.png" },
  { code:"UL2074A",family:"Post Base Plates",description:"Tall L/angle-style upstand",specs:["89mm upstand","6.0mm plate","plan 152/76/76","4 holes 14 dia"],image:IMG+"ul2074a-v2.png" },
  { code:"UL2075",family:"Post Base Plates",description:"L/angle-style upstand for UL1001 Series; labelled UL1001 Series",specs:["41mm upstand","6.0mm plate","plan 152/76/76","4 holes 14 dia"],image:IMG+"ul2075-v2.png" },
  { code:"UL2075A",family:"Post Base Plates",description:"Tall L/angle-style upstand for UL1001 Series",specs:["89mm upstand","6.0mm plate","plan 152/76/76","4 holes 14 dia"],image:IMG+"ul2075a-v2.png" },
  { code:"UL1184PVC",family:"Accessories",description:"Snap-in PVC closure strip; clips into the channel slot to close the open face on exposed or trunking runs",specs:["1.6mm PVC","Grey or White","3000mm length"],image:IMG+"ul1184pvc.png" },
