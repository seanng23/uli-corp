...
export const FITTINGS: Fitting[] = [
  ...
  { code:"UL1130",family:"Angular Fittings",description:"Gusseted shelf/support bracket, triangular web, slotted holes in base (2 slots) and 2 holes in upright face",specs:["A = 168mm, B = 102mm","93mm upright height","47mm base width","38 and 38mm slot spacings"],image:IMG+"ul1130-v2.png" },
  { code:"UL1131",family:"Angular Fittings",description:"Gusseted shelf/support bracket, triangular web, slotted holes in base (2 slots) and 2 holes in upright face",specs:["A = 219mm, B = 152mm","93mm upright height","47mm base width","38 and 38mm slot spacings"],image:IMG+"ul1130-v2.png" },
...
export const CANTILEVER_BRACKETS: CatalogueItem[] = [
  ...
  { code:"UL254/A1",description:"Angular cantilever arm on a 9mm backing plate; for inclined faces and channel concrete inserts",specs:["Arm lengths 150 / 200 / 250 / 350 / 450 / 550 / 600 / 650mm","Various angles available"],image:CB+"cb-ul254a1-v3.png" },
  { code:"UL254/A2",description:"Angular cantilever arm with raker brace, on a 9mm backing plate",specs:["Arm lengths 650 / 800 / 850 / 1050mm","Various angles available"],image:CB+"cb-ul254a2-v3.png" },
  { code:"UL254/A3",description:"Angular double channel cantilever arm on a 9mm backing plate",specs:["Arm lengths 650 / 800 / 850 / 1050mm","Various angles available"],image:CB+"cb-ul254a3-v4.png" },
];

const CI = "/images/products/metal-framing/inserts/";
export const CONCRETE_INSERTS: CatalogueItem[] = [
  { code:"UL33/C",description:"Cast-in channel concrete insert with welded anchors; takes UliStrut® fittings without drilling into the structure",specs:["41 x 56mm profile, 2.5mm thick","Insert lengths 200 - 2000mm","Other insert lengths available"],image:CI+"ci-ul33c-v3.png" },
  { code:"UL10/C",description:"Cast-in channel concrete insert with welded anchors, deep UL1000-profile channel",specs:["41 x 76mm profile, 2.5mm thick","Insert lengths 200 - 2000mm","Other insert lengths available"],image:CI+"ci-ul10c-v3.png" },
];
