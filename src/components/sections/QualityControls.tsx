    ...
    <>
      <section className="site-container py-14 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_4px_1fr] gap-0 lg:gap-x-14 items-stretch">
          ...
          {/* Left — two text blocks with horizontal rule between */}
          <FadeUp className="flex flex-col justify-center pb-10 lg:pb-0">
            <div>
              <h2 className="font-typewriter text-[clamp(1.4rem,2.5vw,2rem)] leading-tight text-[#1A0F00] mb-4">
                Stringent Quality Controls Across Every Step
              </h2>
            ...
            <hr className="border-t border-[#1A0F00] my-8" />
          ...
          <FadeUp delay={0.1} className="flex flex-col">
            ...
            <p className="font-raleway text-[15px] text-[#5C4A30] leading-relaxed mt-5">
              ...
              our manufacturing process. From raw material inspection to final packaging, every product
              is checked, tested, and validated to meet the highest standards of safety, durability,
              and performance.
            </p>
          </FadeUp>
