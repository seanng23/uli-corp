...
export const categories: Category[] = [
  ...
  },
  {
    ...
    name: "Floor Trunking Distribution Systems",
    description:
      "Underfloor, Raisedfloor, and Flushfloor Trunking Systems in galvanized steel for cable distribution in offices and public areas, complete with junction boxes, service outlet boxes, vertical access boxes, and accessories.",
    image: "/images/products/floor-trunking/ft-distribution-v1.png",
  },
];
...
export const products: Product[] = [
  ...
  // ── Floor Trunking Distribution Systems ──────────────────────────────
  {
    slug: "underfloor-trunking-systems",
    name: "Underfloor Trunking Systems",
    subcategory: "Floor Trunking Distribution Systems",
    category: "Floor Trunking Distribution Systems",
    categorySlug: "floor-trunking-systems",
    itemNo: "UFD · UTX · UJX · USX",
    description:
      "Power and data distribution across screed floors or concrete slabs: uPVC ducts, galvanized steel underfloor trunking, junction boxes, service boxes, vertical access boxes and accessories.",
    image: "/images/products/floor-trunking/underfloor/uft-listing-v1.png",
    standards: ["Others/Custom"],
    dimensions: {
      height: ["25", "32", "38"],
      width: ["50", "75", "100", "150", "200", "225", "250", "275", "300", "350"],
      length: ["2440", "2900", "3000"],
      thickness: ["1.6"],
    },
    finishing: ["Pre-Galvanised Steel (Unpainted)", "Heavy Gauge uPVC"],
    specs: [
      { label: "Duct Heights (mm)", values: ["25", "38"] },
      { label: "Trunking Depths (mm)", values: ["25", "32", "38"] },
      { label: "Compartments", values: ["1", "2", "3"] },
    ],
  },
  {
    ...
    itemNo: "RTH · RJH · RSH",
    description:
      "Cable distribution beneath 600 x 600 mm raised access floor panels: trunking, junction boxes, service boxes, header boxes, tap-off units, pedestal boxes and vertical access boxes.",
    image: "/images/products/floor-trunking/raisedfloor/rft-listing-v1.png",
    standards: ["Others/Custom"],
    dimensions: {
      height: ["25", "40", "50", "75", "100"],
      width: ["100", "150", "200", "300", "400", "450", "500"],
      length: ["2440"],
      thickness: ["1.6"],
    },
    finishing: ["Epoxy Powder Coated", "Pre-Galvanised Steel (Unpainted)"],
    specs: [
      { label: "Heights (mm)", values: ["25", "40", "50", "75", "100"] },
      { label: "Widths (mm)", values: ["100", "150", "200", "300", "400", "450", "500"] },
      { label: "Compartments", values: ["1", "2", "3"] },
    ],
  },
  {
    ...
    itemNo: "FTH · FJH · FS",
    description:
      "Main and sub trunking flush to the finished floor, with junction boxes, service boxes, reducers, end caps, joints and vertical access risers in galvanized steel.",
    image: "/images/products/floor-trunking/flushfloor/fft-listing-v1.png",
    standards: ["Others/Custom"],
    dimensions: {
      height: ["32", "40", "50", "60", "65", "73"],
      width: ["100", "150", "200", "280", "300", "400", "450", "500", "600", "700"],
      length: ["2440"],
      thickness: ["1.6", "3.0"],
    },
    finishing: ["Pre-Galvanised Steel (Unpainted)", "Epoxy Powder Coated"],
    specs: [
      { label: "Heights (mm)", values: ["32", "40", "50", "60", "65", "73"] },
      { label: "Main Trunking Widths (mm)", values: ["400", "500", "700"] },
      { label: "Sub Trunking Widths (mm)", values: ["280", "300"] },
      { label: "Compartments", values: ["1", "2", "3"] },
    ],
  },
];
