...
const MAIN_IMAGE = "/images/products/metal-framing-v1.png";
  ...
  return <>
    ...
    {tab === "channels" ? <div id="channels" className="site-container py-10 lg:py-12"><div className="grid grid-cols-1 lg:grid-cols-[1fr_500px] xl:grid-cols-[1fr_540px] gap-10 lg:gap-14 items-start">
      <div className="min-w-0">
        <div className="mb-10 relative aspect-square overflow-hidden rounded-2xl border border-[#1A0F00]/20 bg-white"><Image fill src={MAIN_IMAGE} alt="U-LI Metal Framing System" className="object-contain" sizes="(max-width:1024px) 100vw, 50vw" priority /></div>
