...
const capabilities = [
  ...
  },
  {
    ...
    image: "/images/technology/Lighting-Rod.jpg",
  ...
  },
  {
    ...
    image: "/images/technology/Metal-Rail.jpg",
  ...
  return (
    <div>
      {capabilities.map((cap, i) => {
        ...
        return (
          <section key={cap.title} className="site-container py-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-14 items-center">
              {isImageLeft ? (
                <>
                  {/* Image — left on desktop, top on mobile */}
                  <FadeUp className="relative h-[420px] lg:h-[500px]">
                    <Image
                      src={cap.image}
                      alt={cap.alt}
                      fill
                  ...
                  <FadeUp delay={0.1} className="pt-8 lg:pt-0">
                    ...
                    <div className="border-t-[4px] border-[#1A0F00] mb-6" />
                ...
                <>
                  ...
                  <FadeUp delay={0.1} className="pt-8 lg:pt-0 order-2 lg:order-1">
                    <img
                      ...
                      alt=""
                      aria-hidden="true"
                      className="w-24 h-24 mb-4 object-contain block ml-auto"
                    />
                    <h2 className="font-typewriter text-[clamp(1.75rem,3.5vw,2.875rem)] leading-[1.05] text-[#1A0F00] mb-5">
                      {cap.title}
                    </h2>
                  ...
                  <FadeUp className="relative h-[420px] lg:h-[500px] order-1 lg:order-2">
                    <Image
                      src={cap.image}
                      alt={cap.alt}
                      fill
