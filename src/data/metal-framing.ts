...
export const FITTINGS: Fitting[] = [
  ...
  { code:"UL2335",family:"Accessories",description:"Channel hanger; wraps the channel and takes a threaded rod from above to suspend a channel run",image:IMG+"ul2335-v2.png" },
