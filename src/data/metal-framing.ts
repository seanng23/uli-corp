...
const PAIR_LOAD_TABLE: SpecTable = { title: "Design Loading Data", columns: ["Product Number (mm)","Design Load per Pair (kg)"], rows: [["UL1272",160],["UL1271",180],["UL1796",440]] };
...
export const FITTINGS: Fitting[] = [
  ...
  { code:"UL1066",family:"Flat Plate Fittings",description:"3-hole straight splice plate",weightG:243,dims:"137mm length",image:IMG+"ul1066.png" },
  { code:"UL1067",family:"Flat Plate Fittings",description:"4-hole straight splice plate",weightG:330,dims:"185mm length",image:IMG+"ul1067.png" },
  { code:"UL1036",family:"Flat Plate Fittings",description:"3-hole 90-degree corner (L-shape) flat plate",weightG:250,dims:"89 x 89mm leg lengths",image:IMG+"ul1036.png" },
  { code:"UL1031",family:"Flat Plate Fittings",description:"4-hole T-shape flat plate (3 holes across the bar, 1 hole on the stem)",weightG:339,dims:"137mm bar length x 89mm overall depth",image:IMG+"ul1031.png" },
  { code:"UL1028",family:"Flat Plate Fittings",description:"5-hole cross (+) shape flat plate (4 arm holes + centre hole)",weightG:425,dims:"137 x 137mm",image:IMG+"ul1028.png" },
  { code:"UL1358",family:"Flat Plate Fittings",description:"4-hole tapered/triangular gusset flat plate (2 holes at wide top edge, 2 holes down the tapering stem)",weightG:450,dims:"89mm top width x 137mm height",image:IMG+"ul1358.png" },
  { code:"UL1068",family:"Angular Fittings",description:"2-hole 90-degree angle bracket (1 hole per leg)",weightG:159,dims:"41 x 58mm",image:IMG+"ul1068.png" },
  { code:"UL1026",family:"Angular Fittings",description:"2-hole 90-degree angle bracket, wider/squat profile (1 hole per leg)",weightG:157,dims:"51 x 47mm",image:IMG+"ul1026.png" },
  { code:"UL1326",family:"Angular Fittings",description:"3-hole 90-degree angle bracket: 1 hole on short leg, 2 holes on long leg",weightG:242,dims:"41 x 105mm; hole offset 36.5mm",image:IMG+"ul1326.png" },
  { code:"UL1325",family:"Angular Fittings",description:"4-hole 90-degree angle bracket: 2 holes on top leg, 2 holes on long down leg",weightG:327,dims:"89 x 105mm; hole offset 36.5mm",image:IMG+"ul1325.png" },
  { code:"UL1749",family:"Angular Fittings",description:"2-hole 90-degree angle bracket with slotted hole on one leg",weightG:194,dims:"66 x 51mm; base 38mm",image:IMG+"ul1749.png" },
  { code:"UL1747",family:"Angular Fittings",description:"3-hole 90-degree angle bracket, long horizontal leg with 2 holes + slotted vertical leg",weightG:263,dims:"66mm, 98mm long leg, base 38mm",image:IMG+"ul1747.png" },
  { code:"UL1359",family:"Angular Fittings",description:"3-hole gusseted (tapered fin) 90-degree bracket: 2 holes on tall tapered face, 1 hole on top flange",weightG:458,dims:"89mm top, 41mm flange, 105mm height",image:IMG+"ul1359.png" },
  { code:"UL1130",family:"Angular Fittings",description:"Gusseted shelf/support bracket, triangular web, slotted holes in base (2 slots) and 2 holes in upright face",weightG:760,dims:"93mm upright height, 47mm base width, 38 and 38mm slot spacings; A 168mm, B 102mm",image:IMG+"ul1130.png",table:SHELF_TABLE },
  { code:"UL1131",family:"Angular Fittings",description:"Gusseted shelf/support bracket, triangular web, slotted holes in base (2 slots) and 2 holes in upright face",weightG:976,dims:"93mm upright height, 47mm base width, 38 and 38mm slot spacings; A 219mm, B 152mm",image:IMG+"ul1130.png",table:SHELF_TABLE },
  { code:"UL1713",family:"Angular Fittings",description:"Cranked/offset cantilever bracket with slotted hole in the angled face and hole in top flange (supports square tube off channel face)",weightG:384,dims:"57mm upright, 89mm top reach, 63mm slot face, 89mm base",image:IMG+"ul1713.png" },
  { code:"UL1186-45°",family:"Angular Fittings",description:"2-hole 45-degree angle bracket (acute; braces a diagonal channel onto a horizontal one)",weightG:256,dims:"77mm long leg, 64mm base leg",image:IMG+"ul1186-45.png" },
  { code:"UL1546-45°",family:"Angular Fittings",description:"2-hole 135-degree obtuse (45-degree brace) angle bracket",weightG:246,dims:"72mm diagonal leg, 55mm base leg",image:IMG+"ul1546-45.png" },
  { code:"UL1033",family:"Angular Fittings",description:"4-hole two-plane wing bracket: 3-hole vertical plate + 1-hole perpendicular wing (channel-to-channel cross connection)",weightG:342,dims:"47 x 137mm",image:IMG+"ul1033.png" },
  { code:"UL1035",family:"Angular Fittings",description:"4-hole two-plane corner wing bracket (2 holes vertical plane, 2 holes horizontal plane), left-hand",weightG:342,dims:"89mm, 89mm, 47mm",image:IMG+"ul1035.png" },
  { code:"UL1034",family:"Angular Fittings",description:"4-hole two-plane corner wing bracket, right-hand mirror of UL1035",weightG:342,dims:"89mm, 89mm, 47mm",image:IMG+"ul1034.png" },
  { code:"UL1331",family:"Angular Fittings",description:"3-hole gusseted corner bracket with triangular web, left-hand (2 holes on tall face, 1 on top flange)",weightG:432,dims:"89mm top, 41mm flange, 105mm height",image:IMG+"ul1331.png" },
  { code:"UL1332",family:"Angular Fittings",description:"3-hole gusseted corner bracket, right-hand mirror of UL1331",weightG:432,dims:"41mm, 89mm, 105mm",image:IMG+"ul1332.png" },
  { code:"UL4376",family:"U Shape Fittings",description:"2-hole U fitting (channel-width saddle straddling a channel end, holes through both side faces)",weightG:358,dims:"89mm height",image:IMG+"ul4376.png" },
  { code:"UL4376-A",family:"U Shape Fittings",description:"3-hole U fitting",weightG:558,dims:"137mm height",image:IMG+"ul4376-a.png" },
  { code:"UL4377",family:"U Shape Fittings",description:"4-hole U fitting",weightG:760,dims:"185mm height",image:IMG+"ul4377.png" },
  { code:"UL1377",family:"U Shape Fittings",description:"4-hole U fitting, wide-throat version (for deeper/back-to-back channel)",weightG:1100,dims:"185mm height",image:IMG+"ul1377.png" },
  { code:"UL4047",family:"U Shape Fittings",description:"3-hole hat/bridge fitting: shallow U bridging over a channel, one hole on top + one on each foot",weightG:284,dims:"136mm overall length, 20mm bridge height, 43mm throat width",image:IMG+"ul4047.png" },
  { code:"UL1047",family:"U Shape Fittings",description:"3-hole hat/bridge fitting, taller bridge (clears a full channel)",weightG:358,dims:"136mm overall length, 41mm bridge height, 43mm throat width",image:IMG+"ul1047.png" },
  { code:"UL1737",family:"U Shape Fittings",description:"Deep U (staple) bracket wrapping over a channel to join two crossing channels; slotted feet",weightG:530,dims:"43mm throat width, 47mm foot, 82mm depth/height",image:IMG+"ul1737.png" },
  { code:"UL2346",family:"U Shape Fittings",description:"5-hole deep box/U wrap-over fitting: 1 hole in top plate + 2 holes in each side face",weightG:726,dims:"137mm top length, 47mm top hole offset, 96mm height, 43 x 41mm throat",image:IMG+"ul2346.png" },
  { code:"ULZB01 (N) - TYPE: UL / L-CP",family:"Z Shape Fittings",description:"Hold-down clamp with fixture, clamping a cable ladder to a Ulistrut support",weightG:160,image:IMG+"ulzb01.png" },
  { code:"UL4045",family:"Z Shape Fittings",description:"2-hole Z (offset) fitting, shallow offset, joining two crossing channels",weightG:180,dims:"20mm offset height, 27mm step, 89mm overall length",image:IMG+"ul4045.png" },
  { code:"UL1045",family:"Z Shape Fittings",description:"2-hole Z (offset) fitting, channel-depth offset",weightG:212,dims:"41mm offset height, 27mm step, 48mm leg length",image:IMG+"ul1045.png" },
  { code:"UL1272",family:"Beam Clamps",description:"C-shaped clamp hooking channel lip to beam flange",weightG:188,dims:"32mm jaw width, 37mm height, 35mm depth",image:IMG+"ul1272.png",table:PAIR_LOAD_TABLE,notes:["M12 x 45 Cone Point Screw"] },
  { code:"UL1271",family:"Beam Clamps",description:"Deep-throat C/G-shaped beam clamp with cone point screw",weightG:466,dims:"37mm jaw, 80mm throat height, 10mm lip, 40mm base",image:IMG+"ul1271.png",table:PAIR_LOAD_TABLE,notes:["M12 x 45 Cone Point Screw"] },
  { code:"UL1796",family:"Beam Clamps",description:"Channel-to-beam-flange wrap clamp (hooks over beam flange, cradles channel)",weightG:466,dims:"51mm, 89mm height, 89mm base length",image:IMG+"ul1796.png",table:PAIR_LOAD_TABLE },
  { code:"UL1379S",family:"Beam Clamps",description:"Flat hook-plate beam clamp holding channel to beam flange; set screw bears on flange",weightG:380,dims:"25mm hook height, 83mm plate length, 10mm thickness/step",image:IMG+"ul1379s.png",table:KN_LOAD_TABLE,notes:["M12 x 35mm Set Screw Included","Clamp Requires M12 x 25mm Hex Head Cap Screw and M12 Channel Nut Not Included."] },
  { code:"UL1386",family:"Beam Clamps",description:"J-hook style beam clamp (hooked strap over flange down to channel)",weightG:230,dims:"13mm hook, 48mm drop length, 6.0mm thickness",image:IMG+"ul1386.png",table:KN_LOAD_TABLE,notes:["Clamp Requires M12 x 35mm Hex Head Cap Screw and M12 Channel Nut Not Included."] },
  { code:"UL2785",family:"Beam Clamps",description:"U-bolt beam clamp: saddle plate + U-bolt securing a single channel under a beam flange",weightG:370,dims:"6.0mm plate thickness, 22mm U-bolt spread, 86mm saddle height, 76mm length",image:IMG+"ul2785.png",notes:["M10 Hex Nuts and 'U' Bolt Included","Design Load: 500kg. Use in Pairs Only. For use with Beams up to (19.1), Thick Flanges and with Channels UL1000, UL3300 and UL3301."] },
  { code:"UL2786",family:"Beam Clamps",description:"U-bolt beam clamp, deep version for back-to-back channel",weightG:410,dims:"6.0mm plate thickness, 22mm U-bolt spread, 127mm saddle height, 76mm length",image:IMG+"ul2786.png",notes:["M10 Hex Nuts and 'U' Bolt Included.","Design Load: 500kg. Use in Pairs Only. For use with Beams up to (19.1), Thick Flanges and with Channels UL1001."] },
  { code:"UL2072",family:"Post Base Plates",description:"U-cradle (3-sided) upstand welded to square base plate, for single channel (UL1000 series); 2 side holes",weightG:1310,dims:"41mm upstand, 6.0mm plate, plan 152/76/76, 4 holes 14 dia",image:IMG+"ul2072.png" },
  { code:"UL2072A",family:"Post Base Plates",description:"Same U-cradle, tall upstand; 4 side holes (2 per face)",weightG:1660,dims:"89mm upstand, 6.0mm plate, plan 152/76/76, 4 holes 14 dia",image:IMG+"ul2072a.png" },
  { code:"UL2073",family:"Post Base Plates",description:"U-cradle for UL1001 Series (back-to-back channel), wide throat; labelled UL1001 Series",weightG:1680,dims:"41mm upstand, 6.0mm plate, plan 152/76/76, 4 holes 14 dia",image:IMG+"ul2073.png" },
  { code:"UL2073A",family:"Post Base Plates",description:"Tall U-cradle for UL1001 Series",weightG:2050,dims:"89mm upstand, 6.0mm plate, plan 152/76/76, 4 holes 14 dia",image:IMG+"ul2073a.png" },
  { code:"UL2074",family:"Post Base Plates",description:"L/angle-style (2-sided) upstand welded to square base plate, single channel",weightG:1310,dims:"41mm upstand, 6.0mm plate, plan 152/76/76, 4 holes 14 dia",image:IMG+"ul2074.png" },
